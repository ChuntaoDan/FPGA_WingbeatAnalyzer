...
<Library LVVersion="13008000">
	...
	<Item Name="Booean to T-F string.vi" Type="VI" URL="../Booean to T-F string.vi"/>
	<Item Name="Boolean to Yes-No string.vi" Type="VI" URL="../Boolean to Yes-No string.vi"/>
	<Item Name="GUI alphanumeric + dash character filter.vi" Type="VI" URL="../GUI alphanumeric + dash character filter.vi"/>
	<Item Name="Make Project Title string.vi" Type="VI" URL="../Make Project Title string.vi"/>
	<Item Name="Get Time Date String.vi" Type="VI" URL="../Get Time Date String.vi"/>
	<Item Name="Seconds to H M S string.vi" Type="VI" URL="../Seconds to H M S string.vi"/>
</Library>
