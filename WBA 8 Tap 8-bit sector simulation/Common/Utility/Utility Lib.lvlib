...
<Library LVVersion="13008000">
	...
	<Item Name="MISSING CODE PLACEHOLDER.vi" Type="VI" URL="../MISSING CODE PLACEHOLDER.vi"/>
	<Item Name="OR Error clusters.vi" Type="VI" URL="../OR Error clusters.vi"/>
	<Item Name="Return exe or development environment.vi" Type="VI" URL="../Return exe or development environment.vi"/>
	<Item Name="Quit LV if in exe.vi" Type="VI" URL="../Quit LV if in exe.vi"/>
	<Item Name="OBSOLETE CODE PLACEHOLDER.vi" Type="VI" URL="../OBSOLETE CODE PLACEHOLDER.vi"/>
</Library>
